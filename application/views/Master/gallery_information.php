          ...
          <div class="col-md-12">
            <div class="card <?php if(!isset($update)){ echo 'collapsed-card'; } ?> card-default">
              <div class="card-header">
                <h3 class="card-title"> <?php if(isset($update)){ echo 'Update'; } else{ echo 'Add New'; } ?> Gallery</h3>
              ...
              <div class="card-body p-0" <?php if(isset($update)){ echo 'style="display: block;"'; } else{ echo 'style="display: none;"'; } ?>>
                <form class="input_form m-0" id="form_action" role="form" action="" method="post">
                  ...
                  <div class="form-group col-md-12">
                    ...
                    <input type="file" name="gallery_img" id="gallery_img" class="form-control form-control-sm">
                  </div>
                </div>
                    ...
                    <div class="row">
                      <div class="col-md-6 text-left">
                        <div class="custom-control custom-checkbox">
                          ...
                          <label for="slider_status" class="custom-control-label">Disable This Gallery</label>
                        </div>
                      </div>
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header border-transparent">
                <h3 class="card-title">List All Gallery</h3>
              </div>
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="btn-group">
                            ...
                            <a href="<?php echo base_url() ?>Master/delete_slider/<?php echo $list->slider_id; ?>" type="button" class="btn btn-sm btn-default" onclick="return confirm('Delete this Gallery');"><i class="fa fa-trash text-danger"></i></a>
                          </div>
                        </td>
