          ...
          <div class="col-md-12">
            <div class="card <?php if(!isset($update)){ echo 'collapsed-card'; } ?> card-default">
              <div class="card-header">
                <h3 class="card-title"> <?php if(isset($update)){ echo 'Update'; } else{ echo 'Add New'; } ?> Carrer Guidance</h3>
              ...
              <div class="card-body p-0" <?php if(isset($update)){ echo 'style="display: block;"'; } else{ echo 'style="display: none;"'; } ?>>
                <form class="input_form m-0" id="form_action" role="form" action="" method="post">
                  <div class="row p-4">
                    ...
                    <label>Carrer Guidance Title</label>
                    <input type="text" class="form-control form-control-sm required" name="slider_title" id="slider_title" value="" placeholder="Carrer Guidance Title" required="">
                  </div>

                  <div class="form-group col-md-12">
                    <label>Select Image</label>
                    <label>Image Size Must Be 600px * 600px</label>
                    <input type="file" name="event_img" id="event_img" class="form-control form-control-sm">
                  </div>
                    ...
                    <div class="row">
                      <div class="col-md-6 text-left">
                        <div class="custom-control custom-checkbox">
                          ...
                          <label for="slider_status" class="custom-control-label">Disable This Carrer Guidance</label>
                        </div>
                      </div>
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header border-transparent">
                <h3 class="card-title">List All Carrer Guidance</h3>
              </div>
